...
class Planner():
  ...
  def update(self, sm, pm, CP, VM, PP):
    ...
    if enabled and not self.first_loop and not sm['carState'].gasPressed and not sm['carState'].brakePressed:  # gasPress is to avoid hard decel after user accelerates with gas while engaged
